...
{
    /// <summary>
    /// Provides a formatter for an <see cref="PInvokeVoidCallCompletedTraceEvent"/> event.
    /// </summary>
    public class PInvokeVoidCallCompletedTraceEventFormatter : IEventFormatter<PInvokeVoidCallCompletedTraceEvent>
    {
        public string Format(PInvokeVoidCallCompletedTraceEvent eventData)
        {
            if (eventData == null)
            {
