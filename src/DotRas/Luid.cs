...
namespace DotRas {
    ...
    public readonly struct Luid : IEquatable<Luid>, IFormattable {
        ...
        public static Luid NewLuid() => ServiceLocator.Default.GetRequiredService<IAllocateLocallyUniqueId>().AllocateLocallyUniqueId();
        ...
        public override bool Equals(object obj) {
            return obj is Luid luid ? Equals(luid) : false;
        }
        ...
        /// <returns><b>true</b> if the objects are equal, otherwise <b>false</b>.</returns>
        public bool Equals(Luid other) => ToInt64() == other.ToInt64();
