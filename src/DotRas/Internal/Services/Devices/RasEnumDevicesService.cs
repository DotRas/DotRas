    ...
    internal class RasEnumDevicesService : IRasEnumDevices {
        ...
        public IEnumerable<RasDevice> EnumerateDevices() {
            ...
            for (var index = 0; index < count; index++) {
                yield return CreateDevice(devices[index]);
            }
        }
        ...
        private RasDevice CreateDevice(RASDEVINFO rasDevInfo) => deviceTypeFactory.Create(rasDevInfo.szDeviceName, rasDevInfo.szDeviceType);
    }
}
