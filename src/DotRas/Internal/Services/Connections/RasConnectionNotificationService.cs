...
namespace DotRas.Internal.Services.Connections {
    internal class RasConnectionNotificationService : DisposableObject, IRasConnectionNotification {
        ...
        private readonly IDictionary<RASCN, RasConnectionNotificationStateObject> notifications = new Dictionary<RASCN, RasConnectionNotificationStateObject>();
        ...
        private IntPtr DetermineHandleForSubscribe(RasNotificationContext context) => context.Connection?.Handle ?? INVALID_HANDLE_VALUE;
