...
namespace DotRas.Tests.Internal.Services.Connections {
    ...
    public class RasGetConnectionStatusServiceTests {
        ...
        [Test]
        public void ThrowsAnExceptionWhenApiIsNull() => Assert.Throws<ArgumentNullException>(() => _ = new RasGetConnectStatusService(null, new Mock<IStructFactory>().Object, new Mock<IIPAddressConverter>().Object, new Mock<IExceptionPolicy>().Object, new Mock<IDeviceTypeFactory>().Object));

        [Test]
        public void ThrowsAnExceptionWhenStructFactoryIsNull() => Assert.Throws<ArgumentNullException>(() => _ = new RasGetConnectStatusService(new Mock<IRasApi32>().Object, null, new Mock<IIPAddressConverter>().Object, new Mock<IExceptionPolicy>().Object, new Mock<IDeviceTypeFactory>().Object));

        [Test]
        public void ThrowsAnExceptionWhenIpAddressConverterIsNull() => Assert.Throws<ArgumentNullException>(() => _ = new RasGetConnectStatusService(new Mock<IRasApi32>().Object, new Mock<IStructFactory>().Object, null, new Mock<IExceptionPolicy>().Object, new Mock<IDeviceTypeFactory>().Object));

        [Test]
        public void ThrowsAnExceptionWhenExceptionPolicyIsNull() => Assert.Throws<ArgumentNullException>(() => _ = new RasGetConnectStatusService(new Mock<IRasApi32>().Object, new Mock<IStructFactory>().Object, new Mock<IIPAddressConverter>().Object, null, new Mock<IDeviceTypeFactory>().Object));
        ...
        public void ThrowsAnExceptionWhenApiReturnsNonZero() {
            ...
            api.Setup(o => o.RasGetConnectStatus(handle, ref It.Ref<RASCONNSTATUS>.IsAny)).Returns(new RasGetConnectStatusCallback((IntPtr h, ref RASCONNSTATUS rasConnStatus) => ERROR_INVALID_HANDLE));
        ...
        public void ErrorCodeIsNullWhenValueIsZero() {
            api.Setup(o => o.RasGetConnectStatus(handle, ref It.Ref<RASCONNSTATUS>.IsAny))
                .Returns(
                    new RasGetConnectStatusCallback(
        ...
        public void ErrorCodeIsSetWhenValueIsNonZero() {
            ...
            Assert.That(result.ErrorCode, Is.EqualTo(1));
        }
    }
}
