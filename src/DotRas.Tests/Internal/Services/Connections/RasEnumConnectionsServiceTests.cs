...
namespace DotRas.Tests.Internal.Services.Connections {
    ...
    public class RasEnumConnectionsServiceTests {
        ...
        [Test]
        public void ThrowsAnExceptionWhenApiIsNull() => Assert.Throws<ArgumentNullException>(() => new RasEnumConnectionsService(null, new Mock<IDeviceTypeFactory>().Object, new Mock<IExceptionPolicy>().Object, new Mock<IStructArrayFactory>().Object, new Mock<IServiceProvider>().Object));

        [Test]
        public void ThrowsAnExceptionWhenDeviceTypeFactoryIsNull() => Assert.Throws<ArgumentNullException>(() => new RasEnumConnectionsService(new Mock<IRasApi32>().Object, null, new Mock<IExceptionPolicy>().Object, new Mock<IStructArrayFactory>().Object, new Mock<IServiceProvider>().Object));

        [Test]
        public void ThrowsAnExceptionWhenExceptionPolicyIsNull() => Assert.Throws<ArgumentNullException>(() => new RasEnumConnectionsService(new Mock<IRasApi32>().Object, new Mock<IDeviceTypeFactory>().Object, null, new Mock<IStructArrayFactory>().Object, new Mock<IServiceProvider>().Object));

        [Test]
        public void ThrowsAnExceptionWhenStructFactoryIsNull() => Assert.Throws<ArgumentNullException>(() => new RasEnumConnectionsService(new Mock<IRasApi32>().Object, new Mock<IDeviceTypeFactory>().Object, new Mock<IExceptionPolicy>().Object, null, new Mock<IServiceProvider>().Object));

        [Test]
        public void ThrowsAnExceptionWhenServiceLocatorIsNull() => Assert.Throws<ArgumentNullException>(() => new RasEnumConnectionsService(new Mock<IRasApi32>().Object, new Mock<IDeviceTypeFactory>().Object, new Mock<IExceptionPolicy>().Object, new Mock<IStructArrayFactory>().Object, null));

        [Test]
        public void ReturnsNoConnectionAsExpected() {
            var api = new Mock<IRasApi32>();
            api.Setup(o => o.RasEnumConnections(It.IsAny<RASCONN[]>(), ref It.Ref<int>.IsAny, ref It.Ref<int>.IsAny))
                .Returns(
        ...
        public void ThrowsAnExceptionWhenTheDeviceIsNull() {
            ...
            Assert.That(ex.Message, Is.EqualTo("The device was not created."));
        }
    }
}
