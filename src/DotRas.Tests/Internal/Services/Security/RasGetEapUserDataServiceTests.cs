...
namespace DotRas.Tests.Internal.Services.Security {
    ...
    public class RasGetEapUserDataServiceTests {
        private delegate int RasGetEapUserDataCallback(IntPtr hToken, string phoneBookPath, string entryName, IntPtr pbEapData, ref int sizeofEapData);
        ...
        public void ResizesTheStructureAsExpected() {
            ...
            api.Setup(o => o.RasGetEapUserData(It.IsAny<IntPtr>(), It.IsAny<string>(), It.IsAny<string>(), IntPtr.Zero, ref It.Ref<int>.IsAny))
                .Returns(
                    new RasGetEapUserDataCallback(
            ...
            api.Setup(o => o.RasGetEapUserData(It.IsAny<IntPtr>(), It.IsAny<string>(), It.IsAny<string>(), ptr, ref It.Ref<int>.IsAny)).Returns(new RasGetEapUserDataCallback((IntPtr token, string path, string name, IntPtr h, ref int l) => SUCCESS));
            ...
            Assert.Multiple(() => {
                Assert.That(eapInfo.pbEapInfo, Is.EqualTo(ptr));
                Assert.That(eapInfo.dwSizeofEapInfo, Is.EqualTo(length));
            });
        ...
        public void DoesNotThrowAnErrorWhenEapIsNotRequired() {
            ...
            api.Setup(o => o.RasGetEapUserData(It.IsAny<IntPtr>(), It.IsAny<string>(), It.IsAny<string>(), IntPtr.Zero, ref It.Ref<int>.IsAny)).Returns(new RasGetEapUserDataCallback((IntPtr token, string path, string name, IntPtr h, ref int l) => SUCCESS));
            ...
            Assert.Multiple(() => {
                Assert.That(eapInfo.pbEapInfo, Is.EqualTo(IntPtr.Zero));
                Assert.That(eapInfo.dwSizeofEapInfo, Is.EqualTo(0));
            });
        }
