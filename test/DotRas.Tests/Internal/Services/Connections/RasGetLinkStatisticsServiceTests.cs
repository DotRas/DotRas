...
{
    [TestFixture]
    public class RasGetLinkStatisticsServiceTests
    {
        private delegate int RasGetLinkStatisticsCallback(
            IntPtr handle,
            int subEntryId,
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new RasGetLinkStatisticsService(null, new Mock<IStructFactory>().Object, new Mock<IExceptionPolicy>().Object));
        }

        [Test]
        public void ThrowsAnExceptionWhenStructFactoryIsNull()
        {
            Assert.Throws<ArgumentNullException>(() => new RasGetLinkStatisticsService(new Mock<IRasApi32>().Object, null, new Mock<IExceptionPolicy>().Object));
        }

        [Test]
        public void ThrowsAnExceptionWhenExceptionPolicyIsNull()
        {
            Assert.Throws<ArgumentNullException>(() => new RasGetLinkStatisticsService(new Mock<IRasApi32>().Object, new Mock<IStructFactory>().Object, null));
        }
        ...
        public void ThrowsAnExceptionWhenHandleIsNull()
        {
            ...
            var target = new RasGetLinkStatisticsService(api.Object, structFactory.Object, exceptionPolicy.Object);
            Assert.Throws<ArgumentNullException>(() => target.GetLinkStatistics(null, 1));
        }
        ...
        public void ReturnsTheStatisticsAsExpected()
        {
            ...
            var api = new Mock<IRasApi32>();
            api.Setup(o => o.RasGetLinkStatistics(handle, 1, ref It.Ref<RAS_STATS>.IsAny)).Returns(new RasGetLinkStatisticsCallback(
                (IntPtr h, int i, ref RAS_STATS stats) =>
                {
            ...
            var target = new RasGetLinkStatisticsService(api.Object, structFactory.Object, exceptionPolicy.Object);
            var result = target.GetLinkStatistics(connection.Object, 1);
        ...
        public void ThrowsAnExceptionWhenTheApiResultIsNonZero()
        {
            var handle = new IntPtr(1);
            var api = new Mock<IRasApi32>();
            api.Setup(o => o.RasGetLinkStatistics(handle, 1, ref It.Ref<RAS_STATS>.IsAny)).Returns(ERROR_INVALID_PARAMETER);
            ...
            var target = new RasGetLinkStatisticsService(api.Object, structFactory.Object, exceptionPolicy.Object);
            Assert.Throws<TestException>(() => target.GetLinkStatistics(connection.Object, 1));
        }
    }
}